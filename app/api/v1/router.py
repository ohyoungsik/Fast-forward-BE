...
from app.api.v1.endpoints import auth, health, infra, log, security, servers, user, webapp_logs
...
api_router.include_router(webapp_logs.router, prefix="/logs/webapp", tags=["webapp-logs"])
